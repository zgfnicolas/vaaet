...
`vaaet-persistence` (`vaaet_persistence`, 0.2.1), `vaaet-ml` (`vaaet_ml`,
4.8.1) y `vaaet-app` reservado. La topología está definida por
...
- **Histórico**: changelog y planes fechados registran su momento; los ADRs
  conservan sus decisiones originales. ADR-0021 a ADR-0030
