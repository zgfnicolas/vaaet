...
`vaaet-persistence` (`vaaet_persistence`, 0.1.0), `vaaet-ml` (`vaaet_ml`,
4.7.0) y `vaaet-app` reservado. La topología está definida por
...
- **Histórico**: changelog y planes fechados registran su momento; los ADRs
  conservan sus decisiones originales. ADR-0021 a ADR-0028
