...
VAAET es un monorepo con `vaaet-core` (`vaaet`, versión interna 0.2.1),
`vaaet-ml` (`vaaet_ml`, versión 4.6.1) y `vaaet-app` reservado. La topología y
...
- **Histórico**: changelog y planes fechados registran su momento; los ADRs
  conservan sus decisiones originales. ADR-0021 a ADR-0027
