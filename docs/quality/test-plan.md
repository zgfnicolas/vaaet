...
VAAET es un monorepo con `vaaet-core==0.2.2` (import `vaaet`) y
`vaaet-persistence==0.3.2` (import `vaaet_persistence`) y
`vaaet-ml==4.9.2` (import `vaaet_ml`). [ADR-0021](../architecture/decisions/0021-portable-core-and-ml-laboratory-boundary.md)
